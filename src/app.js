...
import Testimonial3 from "./assets/img/testimaniols-3.png";
import PortfolioDesign from "./assets/img/portfolio-design.png";
import Developer from "./assets/img/developer.png";

import Testimonial2 from "./assets/img/testimonials-2.png";
    ...
    <aside id="side-nav">
      <div class="side-nav__content">
        ...
        <ul class="side-nav__content--social">
          <a href="https://github.com/yilmazbingo">
            <i class="fab fa-github"></i>
          </a>
          <a href="https://twitter.com/bingolyilmazny">
            <i class="fab fa-twitter"></i>
          </a>
          <a href="https://www.linkedin.com/feed/">
            <i class="fab fa-linkedin-in"></i>
          </a>
          <a href="https://www.instagram.com/yilmazcik/">
            <i class="fab fa-instagram"></i>
          </a>
          <a href="https://stackoverflow.com/users/10262805/yilmaz">
    ...
    <main>
      ...
      <section id="showcase">
        <div class="showcase__content">
          ...
          <p class="showcase__content--para">
            The goal of this project to get hired
          </p>
      ...
      <section id="testimonials">
        <div class="testimonials__card">
          <div class="testimonials__card--img">
            <img src={Testimonial3} alt="tony" />
          </div>
          <div class="testimonials__card--content">
            <h3 class="testimonials__card--content__title">Mobile Apps</h3>
        ...
        <div class="testimonials__card">
          <div class="testimonials__card--img">
            <img src={Testimonial} alt="natasha" />
          </div>
          <div class="testimonials__card--content">
      ...
      <section id="testimonials">
        <div class="testimonials__card">
          <div class="testimonials__card--img">
            <img src={PortfolioDesign} alt="tony" />
          </div>
          <div class="testimonials__card--content">
        ...
        <div class="testimonials__card">
          ...
          <div class="testimonials__card--content">
            <h3 class="testimonials__card--content__title">Ecommerce</h3>
            <p class="testimonials__card--content__para">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam
              sunt quis cupiditate ducimus non esse?
            </p>
        ...
        <div class="testimonials__card">
          <div class="testimonials__card--img">
            <img src={Developer} alt="veers" />
          </div>
          <div class="testimonials__card--content">
            <h3 class="testimonials__card--content__title">Engineering</h3>
            <p class="testimonials__card--content__para">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam
              sunt quis cupiditate ducimus non esse?
            </p>
